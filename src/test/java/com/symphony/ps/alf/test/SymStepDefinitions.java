...
public class SymStepDefinitions implements En {
    ...
    // Listeners
    private IMListener imListener = AlfService.locateImplementation(IMListener.class);
    private RoomListener roomListener = AlfService.locateImplementation(RoomListener.class);
    private ConnectionListener connectionListener = AlfService.locateImplementation(ConnectionListener.class);
    private ElementsListener elementsListener = AlfService.locateImplementation(ElementsListener.class);
